...
export const addFavorite = async (req: Request, res: Response) => {
    ...
    try {
        ...
        return res.status(201).send(<IServerResponse>({ status: 'success', data: savedFavourite }))
...
export const removeFavorite = async (req: Request, res: Response) => {
    try {
        ...
        return res.status(200).send(<IServerResponse>({ status: 'success', message: 'Product Deleted' }))
    } catch (error: any) {
        return res.status(400).send(<IServerResponse>({ status: 'error', message: error.message || error }))
    }
}
...
export const getFavorites = async (req: Request, res: Response) => {
    try {
        ...
        return res.status(200).send(<IServerResponse>({ status: 'success', data: userWishlist }))
    } catch (error: any) {
        return res.status(400).send(<IServerResponse>({ status: 'error', message: error.message || error }))
    }
}